...
var Icon = React.forwardRef(({
  ...
  const [phosphorLoaded, setPhosphorLoaded] = React.useState(false);
  React.useEffect(() => {
    setIsClient(true);
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      ...
      children: IconComponent && React.createElement(IconComponent, iconProps)
    }
  );
});
Icon.displayName = "Icon";
var EmotionIcon = React.forwardRef(
  (props, ref) => /* @__PURE__ */ jsx(Icon, { ref, name: "smile", ...props })
);
EmotionIcon.displayName = "EmotionIcon";
var StatusIcon = React.forwardRef(
  (props, ref) => /* @__PURE__ */ jsx(Icon, { ref, name: "info", ...props })
);
StatusIcon.displayName = "StatusIcon";
var LoadingIcon = React.forwardRef(
...
var QuickActionCard = React.forwardRef(
  ({
    title,
    description,
    icon,
...
var DashboardGrid = React.forwardRef(
  ({
    columns = 4,
    gap = "md",
    responsive = true,
...
var ActivityFeed = React.forwardRef(
  ({
    title,
    items,
...
var MembershipBadge = React.forwardRef(
  ({
    tier,
    label,
    size = "md",
...
var MiniBarChart = React.forwardRef(
  ({
    data,
    labels,
    maxValue,
...
var SummaryCard = React.forwardRef(
  ({
    title,
    value,
    subtitle,
...
var NotificationCard = React.forwardRef(
  ({
    title = "\uC54C\uB9BC \uBC0F \uACF5\uC9C0",
    items,
...
var ProgressCard = React.forwardRef(
  ({
    title,
    current,
    total,
...
export { ActivityFeed, DashboardGrid, MembershipBadge, MetricCard, MiniBarChart, NotificationCard, ProfileCard, ProgressCard, QuickActionCard, StatCard, SummaryCard };
