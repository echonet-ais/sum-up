...
var cn = merge;
var AdvancedPageTransition = React__default.default.forwardRef(({
  children,
  className,
  type = "fade",
  duration = 500,
...
var FadePageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "fade", ...props }));
var SlidePageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "slide", ...props }));
var ScalePageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "scale", ...props }));
var FlipPageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "flip", ...props }));
var MorphPageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "morph", ...props }));
var CubePageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "cube", ...props }));
var ZoomPageTransition = React__default.default.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(AdvancedPageTransition, { ref, type: "zoom", ...props }));
...
var usePageTransition = (initialConfig = {}) => {
  ...
  const getEasingFunction = React.useCallback((easing) => {
    const easingFunctions = {
      linear: (t) => t,
      "ease-in": (t) => t * t,
      "ease-out": (t) => 1 - Math.pow(1 - t, 2),
...
var usePageTransitionManager = (config = {}) => {
  ...
  const activeTransitionsRef = React.useRef(/* @__PURE__ */ new Map());
  const transitionCounterRef = React.useRef(0);
  const logDebug = React.useCallback((message, data) => {
    if (enableDebug) {
      console.log(`[PageTransitionManager] ${message}`, data);
    }
  }, [enableDebug]);
  const updateStats = React.useCallback((newTransition) => {
    setState((prev) => {
  ...
  const startTransition = React.useCallback(async (config2) => {
  ...
  const cancelTransition = React.useCallback((id) => {
  ...
  const getTransitionStats = React.useCallback(() => {
